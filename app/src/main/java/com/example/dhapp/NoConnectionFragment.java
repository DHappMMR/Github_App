...
public class NoConnectionFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        back.setOnClickListener(v ->  {
            ...
            fragmentTransaction.replace(R.id.fragment_no_connection, newFrag,"tag");
            fragmentTransaction.addToBackStack(null);
            fragmentTransaction.commit();*/

            //Log.i("Information", "End new Fragment");


            //intent = new Intent(requireContext(), NoConnectionFragment.class);

           // Log.i("Information", "End of starting new Activity");
        });
